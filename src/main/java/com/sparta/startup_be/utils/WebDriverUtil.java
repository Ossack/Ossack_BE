...
//                System.out.println(driver.findElement(By.cssSelector("iframe")).getAttribute("id"));
    ...
    public List<Estate> useDriverNemo() throws InterruptedException {
        driver.get("https://www.nemoapp.kr/Search?ArticleType=2&PageIndex=0&StoreTrade=false&CompletedOnly=false&SWLng=126.66848090721923&SWLat=37.38157557180298&NELng=127.3635496868374&NELat=37.65855645022087&Zoom=12&mode=1&category=1&list=true&articleId=&dataType=");
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(10000, TimeUnit.MILLISECONDS);  // 페이지 불러오는 여유시간.
        log.info("++++++++++++++++++++++===================+++++++++++++ selenium : " + driver.getTitle());
        try {
