...
//                }
                    ...
                    String info = driver.findElement(By.className("detail_info_general")).getText();
                    ...
                    List<String> subwayList = new ArrayList<>();
                    List<WebElement> subways = driver.findElement(By.className("detail_metro_list")).findElements(By.className("detail_list_item"));
                    for(WebElement subway : subways){
                        subwayList.add(subway.getText());
                    }
                    EstateRequestDto estateDto = EstateRequestDto.builder()
                            .id(id).area(area).buildingFloor(buildingFloor).roomFloor(roomFloor).imageList(imageList).subwayList(subwayList)
